...
struct Board: View {
    ...
    var body: some View {
        NavigationLink(destination: DummyBoardDetail(boardName: boardName, postId: 1)) {
            VStack(alignment: .leading, spacing: 12) {
                ...
                Text(content)
                    ...
                    .foregroundColor(Constants.Gray900)
                    .lineLimit(2) // 글 내용 줄 수를 제한하여 너무 길어지지 않도록 함
        ...
        .buttonStyle(PlainButtonStyle()) // NavigationLink를 Button처럼 보이게 설정
    }
}
