...
struct EmploymentWriteBoardDetail: View {
    ...
    @Binding var selectedBoardCategory: Int?
    @Binding var titleText: String
    @Binding var postText: String
    @Binding var selectedCategoryIndex: Int?
    @Binding var selectedSupportFieldIndex: Int?
    @Binding var selectedEmploymentType: Int?
    @Binding var selectedEducationLevel: Int?
...
struct EmploymentCategoryDropDownMenuView: View {
    ...
    var body: some View {
        CategoryDropDownMenu(options: ["질문 게시판", "취업후기 게시판", "대학원생활 게시판", "연구주제 게시판"],
