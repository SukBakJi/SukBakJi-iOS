...
class PostListTableViewCell: UITableViewCell {
    ...
    func prepare(postList: PostList) {
        titleLabel.text = postList.title
        contentLabel.text = postList.previewContent
        commentLabel.text = String(postList.commentCount)
        viewLabel.text = String(postList.views)
    }
}
