...
extension UnivRecruitViewController {
    ...
    private func setUnivRecruitTypeAPI() {
        ...
        APIService.shared.getWithTokenAndParams(of: APIResponse<UnivMethod>.self, url: url, parameters: params, accessToken: retrievedToken)
    ...
    private func setUnivAPI() {
        ...
        APIService.shared.postWithToken(of: APIResponse<String>.self, url: url, parameters: params, accessToken: retrievedToken)
