...
class UnivRecruitViewController: UIViewController {
    ...
    private func setUI() {
        ...
        self.view.addSubview(dateSelectLabel)
        ...
        self.view.addSubview(recruitSelectLabel)
        ...
        recruitDateLabel.snp.makeConstraints { make in
            make.top.equalTo(recruitView.snp.bottom).offset(20)
            make.leading.equalToSuperview().offset(24)
           make.height.equalTo(21)
        }
        ...
        recruitTypeLabel.addImageAboveLabel(referenceView: recruitFirstButton, spacing: 29.5)
        ...
        self.view.addSubview(warningTypeLabel)
    ...
    private func updateButtonColor() {
        if (recruitTypeTextField.text?.isEmpty == false) {
            ...
            nextButton.setBackgroundColor(UIColor(named: "Coquelicot")!, for:.normal)
            nextButton.setTitleColor(.white, for: .normal)
        } else {
            nextButton.isEnabled = false
            nextButton.setBackgroundColor(UIColor(hexCode: "EFEFEF"), for: .normal)
            nextButton.setTitleColor(UIColor(hexCode: "9F9F9F"), for: .normal)
        }
    }
