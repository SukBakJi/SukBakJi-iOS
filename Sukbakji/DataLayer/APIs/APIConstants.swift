...
extension APIConstants {
    ...
    var path: String {
        ...
        case .labsFavoriteToggle(let labId):
            return APIConstants.makeEndPoint("/labs/\(labId)/favorite")
        case .labsSearch:
        ...
        case .labsReviewsSearch:
            return APIConstants.makeEndPoint("/labs/reviews/search")
        case .labsReviews:
