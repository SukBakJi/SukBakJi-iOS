...
class BoardDoctorView: UIView {
    ...
    let doctorMenuCollectionView: UICollectionView = {
        ...
        cv.register(DoctorMenuCollectionViewCell.self, forCellWithReuseIdentifier: DoctorMenuCollectionViewCell.identifier)
    ...
    let doctorPostTableView = UITableView().then {
        $0.backgroundColor = .clear
        $0.separatorStyle = .none
        $0.register(DoctorPostTableViewCell.self, forCellReuseIdentifier: DoctorPostTableViewCell.identifier)
    ...
    private func setupUI() {
        ...
        addSubview(doctorMenuCollectionView)
        addSubview(titleLabel)
        addSubview(doctorPostTableView)
    }
    ...
    private func setupConstraints() {
        ...
        doctorMenuCollectionView.snp.makeConstraints {
            $0.top.equalTo(boardSearchTextField.snp.bottom)
            $0.leading.trailing.equalToSuperview()
            $0.height.equalTo(52)
        }
        doctorMenuCollectionView.showsHorizontalScrollIndicator = false
        
        titleLabel.snp.makeConstraints {
            $0.top.equalTo(doctorMenuCollectionView.snp.bottom).offset(4)
            $0.leading.trailing.equalToSuperview().inset(24)
            $0.height.equalTo(52)
        }
        
        doctorPostTableView.snp.makeConstraints {
