...
class BoardMasterView: UIView {
    ...
    let masterMenuCollectionView: UICollectionView = {
        ...
        collectionView.register(MasterMenuCollectionViewCell.self, forCellWithReuseIdentifier: MasterMenuCollectionViewCell.identifier)
    ...
    private func setUI() {
        ...
        masterPostTableView.backgroundColor = .clear
        masterPostTableView.separatorStyle = .none
        ...
        rootFlexContainer.flex.direction(.column).paddingTop(55).define { flex in
            ...
            flex.addItem(masterMenuCollectionView).height(52).marginTop(0)
    ...
    @objc private func textFieldTapped() {
        let nextVC = BoardSearchViewController(title: "석사 게시판", menu: "석사")
